...
<div class="single_stuff wow fadeInDown">
    <div class="single_stuff_img"> <a href="index.php?p=chitiettin&idTin=<?=$rowTM['idTin']; ?>"><img src="<?=$rowTM['urlHinh'] ?>" onerror="this.src='defaultImg.jpg'" width="100%" height="300px"></a> </div>
